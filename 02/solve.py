...
var_len = 4
#fin will hold our symbolic hash input array
...
remainder = fin.get_bytes(1,hash_len-1)

#flag will collect our solved constraints
flag = ""
#there is a hardcoded lenth of 44 characters
for i in range(44):
	#format the first part of the input is c-HH where c is the char
	...
	#these constraints are temp because we only need them for this i
	tmp = [res == ith_hash, remainder == fixed]
